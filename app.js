...
mongoose
  .connect(`mongodb+srv://${process.env.AUTH}:${process.env.PASSWORD}@cluster0.ws6tl.mongodb.net/<dbname>?retryWrites=true&w=majority`, {useNewUrlParser: true, useUnifiedTopology: true})
  .then(x => {
